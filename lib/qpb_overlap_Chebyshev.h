/* NOTE: The definitions of all functions are included allowing this way flexibility
     in the order of functions within the script. */
...
void qpb_gamma5_sign_function_of_H(qpb_spinor_field, qpb_spinor_field);
...
qpb_double scalar_r_func(qpb_double);
