...
void
qpb_spinor_xdoty(qpb_complex *dot_prod, qpb_spinor_field x, qpb_spinor_field y)
{
  qpb_double dot_prod_reim[2] = {0., 0.};
  ...
  MPI_Allreduce(MPI_IN_PLACE, dot_prod_reim, 2, MPI_DOUBLE, MPI_SUM, MPI_COMM_WORLD);
