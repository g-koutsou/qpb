...
fp = open("qpb_sun_mul.h", "w")
fp.write("#ifndef _QPB_SUN_MUL_H\n" + 
...
for NC in [1, 3]:
    ...
    fp.write("sun_mul_uu(qpb_complex *z, qpb_complex *x, qpb_complex *y)\n{\n")
    z = x*y
    for i in range(NC):
        for j in range(NC):
            k = j + i*NC            
    ...
    ### U * U^+
    fp.write("__inline__ void\n")
    fp.write("sun_mul_ud(qpb_complex *z, qpb_complex *x, qpb_complex *y)\n{\n")
    ...
    ### U^+ * U
    fp.write("__inline__ void\n")
    fp.write("sun_mul_du(qpb_complex *z, qpb_complex *x, qpb_complex *y)\n{\n")
    ...
    ### U^+ * U^+
    fp.write("__inline__ void\n")
    fp.write("sun_mul_dd(qpb_complex *z, qpb_complex *x, qpb_complex *y)\n{\n")
    ...
    ### a * U
    fp.write("__inline__ void\n")
    fp.write("sun_mul_au(qpb_complex *z, qpb_complex a, qpb_complex *x)\n{\n")
    z = a*x
    for i in range(NC):
        for j in range(NC):
            k = j + i*NC            
